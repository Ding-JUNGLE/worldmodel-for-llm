...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/external_memory_effectiveness_v1/candidates}"
MODEL_DIR="${MODEL_DIR:-$ROOT_DIR}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-$ROOT_DIR/base_distilled_model/base_distill.safetensors}"
IMG_PATH="${IMG_PATH:-$ROOT_DIR/demo_images/gta_drive/0000.png}"
CONFIG_PATH="${CONFIG_PATH:-$ROOT_DIR/configs/inference_yaml/inference_gta_drive.yaml}"
