# Demo V2 Expanded Evidence Upload Report

## Diagnosis

- PASS_MINIMUM_EVIDENCE_ONLY
...
- audited and reported: seed1..seed8
- seed9..seed16 were not available in the current package

## Random trials

- existing 10 random-memory trials reused
- label: `RANDOM_TRIALS_LIMITED_TO_EXISTING_10`
...
## Manual eval uploaded

- `results/evaluation/manual_review_table_template.csv`
- `figures/demo_v2/manual_review_contact_sheet.png`

## Proxy metrics uploaded

- `results/evaluation/automatic_proxy_metrics.csv`
- `results/evaluation/automatic_proxy_metrics.md`

## Assignment mapping uploaded

- `docs/final/assignment_requirement_mapping_v2.md`

## Remaining limitations

- Evidence tier is `MINIMUM_PASS`, not `STRONG_PASS`
- Candidate pool remains seed1..seed8
- Random-memory control remains limited to the existing 10 trials
- Manual review is `template_only`, not multi-reviewer evidence

## What teammates should use first
